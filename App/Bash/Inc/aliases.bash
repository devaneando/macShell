...
alias guestRestart="dockerStop ${DEVELOPEMENT_HOME}/Guest/dev_environment && dockerStart ${DEVELOPEMENT_HOME}/Guest/dev_environment"
alias kadu="kadu"
alias la='ls -AFhot'
...
alias guestLog="tail -f ${DEVELOPEMENT_HOME}/Guest/dev_environment/logs/apache2/php_errors.log"
